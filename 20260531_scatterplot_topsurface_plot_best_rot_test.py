...
corner = 'R'
root_folder = 'C:/Users/iselire/OneDrive/studium/unifr/solvent_evaporation_annealing/evaluation_crosssections/evaluation/20240623_test_12x200_iterations_optimize_1000x1000_rot/R'
samples_dir = 'C:/Users/iselire/OneDrive/studium/unifr/solvent_evaporation_annealing/evaluation_crosssections/evaluation/20240623_test_12x200_iterations_optimize_1000x1000_rot/R'
save_folder = 'C:/Users/iselire/OneDrive/studium/unifr/solvent_evaporation_annealing/evaluation_crosssections/evaluation/20240623_test_12x200_iterations_optimize_1000x1000_rot/R'
...
for directory in range(1, len(csv_files_data_2), 1):
    topsurface_arrays = overallcorr_to_array(csv_files_data_1[directory][1][0], 'yes')
    overallcorr_arrays = overallcorr_to_array(csv_files_data_2[directory][1][0], 'yes')
    ...
    for i in range(1, len(overallcorr_arrays)):
        ...
        single_corr_1.append(single_correlation[0][i])
        single_corr_2.append(single_correlation[1][i])
        single_corr_3.append(single_correlation[2][i])
        single_corr_4.append(single_correlation[3][i])
...
sc = ax.scatter(X, Y, Z, c=plt_corr, cmap=reversed_map, s = int_corr, vmin = min_threshold, vmax = max_threshold)
